...
std::cout << "Creating file\n";
  ...
  std::cout << "Created handle: " << Cport[comport_number] << '\n';
...
std::cout << "Builded Comm DCBA file\n";
  ...
  std::cout << "Setting handle: " << Cport[comport_number] << '\n';
...
std::cout << "Set Comm Timeouts file\n";
...
void RS232_CloseComport(int comport_number)
{
  std::cout << "Closing handle: " << Cport[comport_number] << '\n';
  CloseHandle(Cport[comport_number]);
}
